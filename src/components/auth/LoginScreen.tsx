...
export function LoginScreen() {
  ...
  return (
    <div className="flex min-h-[80vh] flex-col items-center justify-center gap-10 bg-white px-5 py-16 text-center">
      <p className="font-display text-lg tracking-[0.2em] text-ink/50">SHIPDA</p>

      <div>
        <p className="font-display text-3xl leading-tight tracking-tight text-ink md:text-5xl">
          내 첫 번째 모바일 가판대,
          <br />
          <span className="text-ink">Shipda</span>
        </p>
        <p className="mt-4 font-body text-sm text-muted md:text-base">
          인스타그램 소상공인과 1인 창업자를 위한 완전 무료 쇼핑몰.
          <br />
          링크 하나로 내 상점을 열고, 바로 판매를 시작해보세요.
        </p>
      </div>
