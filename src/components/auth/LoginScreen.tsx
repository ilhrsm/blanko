...
export function LoginScreen() {
  ...
  return (
    <div className="flex h-[80vh] flex-col items-center justify-center gap-8 px-5 text-center">
      <div>
        <p className="font-display text-3xl tracking-tight text-ink md:text-4xl">SMALLCAM</p>
        <p className="mt-3 font-body text-sm text-muted">
          구글 계정으로 로그인하면 바로 내 쇼핑몰에서 판매를 시작할 수 있어요.
        </p>
      </div>
      <button
        onClick={handleLogin}
