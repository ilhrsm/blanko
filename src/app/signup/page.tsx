...
export default function SignupPage() {
  ...
  return (
    <div className="mx-auto flex min-h-[80vh] max-w-md flex-col justify-center gap-8 bg-white px-5 py-16">
      <div className="text-center">
        <p className="font-display text-2xl tracking-tight text-ink">내 상점 만들기</p>
